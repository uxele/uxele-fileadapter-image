...
describe("ImageAdapter", function () {
    ...
    describe("\"Image File: \"base/testAssets/nature.jpeg\"", function () {
        function decodeProject() {
            return __awaiter(this, void 0, void 0, function () {
                var f, project;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, loadRemoteFile_1.loadRemoteFile({ url: "base/testAssets/nature.jpeg" }).toPromise()];
                        case 1:
                            f = _a.sent();
        ...
        it("should decode an image file", function () { return __awaiter(_this, void 0, void 0, function () {
            var project;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, decodeProject()];
        ...
        it("should get page from a project", function () { return __awaiter(_this, void 0, void 0, function () {
            var page;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getPages()];
        ...
        it("should not get layers", function () { return __awaiter(_this, void 0, void 0, function () {
            var page, layers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getPages()];
